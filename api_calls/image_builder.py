...
def get_images(items, killer, victim, time, gilda_killer, gilda_victim, ip_killer, ip_victim, total_victim_killfame, message):
    ...
    img_draw.text((20, 10), f'Vrah: {killer}', fill='white', font=font)
    img_draw.text((380, 10), f'Obet: {victim}', fill='white', font=font)
    img_draw.text((110, 240), f'Cas (server): {time}', fill='white', font=font)
    img_draw.text((110, 280), f'Fame za zabiti: {total_victim_killfame}', fill='white', font=font)
    img_draw.text((110, 320), f'{message}', fill='white', font=font)
